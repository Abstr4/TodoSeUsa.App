...
public static class DbSeeder
{
    ...
    private static async Task SeedProductsAsync(ApplicationDbContext context)
    {
        ...
        {
            new() { Price = 100, Category = "Electronics", Description = "Wireless Mouse", Quality = ProductQuality.New, ConsignmentId = consignment.Id, BoxId = box.Id },
            new() { Price = 250, Category = "Home", Description = "Blender", Quality = ProductQuality.Good, ConsignmentId = consignment.Id, BoxId = box.Id },
            new() { Price = 800, Category = "Clothing", Description = "Jacket", Quality = ProductQuality.Fair, ConsignmentId = consignment.Id, BoxId = box.Id },
            new() { Price = 2000, Category = "CategoryTest1", Description = "DescriptionTest1", Quality = ProductQuality.New, ConsignmentId = consignment.Id, BoxId = box.Id },
            new() { Price = 4030, Category = "CategoryTest2", Description = "DescriptionTest2", Quality = ProductQuality.Poor, ConsignmentId = consignment.Id, BoxId = box.Id },
            new() { Price = 6050, Category = "CategoryTest3", Description = "DescriptionTest3", Quality = ProductQuality.LikeNew, ConsignmentId = consignment.Id, BoxId = box.Id },
            new() { Price = 12980, Category = "CategoryTest4", Description = "DescriptionTest4", Quality = ProductQuality.Fair, ConsignmentId = consignment.Id, BoxId = box.Id },
            new() { Price = 8130, Category = "CategoryTest5", Description = "DescriptionTest5", Quality = ProductQuality.Fair, ConsignmentId = consignment.Id, BoxId = box.Id }
        };
