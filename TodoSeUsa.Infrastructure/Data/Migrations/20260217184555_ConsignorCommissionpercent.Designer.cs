...
namespace TodoSeUsa.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260217184555_ConsignorCommissionpercent")]
    partial class ConsignorCommissionpercent
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TodoSeUsa.Domain.Entities.Payout", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TodoSeUsa.Domain.Entities.SaleItem", b =>
                {
                    ...
                    b.Property<decimal>("ConsignorPercent")
                        .HasPrecision(3)
                        .HasColumnType("decimal(3,0)");
                    ...
                    b.ToTable("SaleItems", null, t =>
                        {
                            t.HasCheckConstraint("CK_SaleItem_ConsignorPercent", "[ConsignorPercent] BETWEEN 0 AND 100");
                        });
                });
            ...
            modelBuilder.Entity("TodoSeUsa.Domain.Entities.PayoutLine", b =>
                {
                    b.HasOne("TodoSeUsa.Domain.Entities.Payout", "Payout")
                        .WithMany("Lines")
                        .HasForeignKey("PayoutId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TodoSeUsa.Domain.Entities.SaleItem", "SaleItem")
                        .WithMany()
