...
public interface IConsignmentService
{
    ...
    Task<Result<bool>> EditByIdAsync(int consignmentId, EditConsignmentDto editConsignmentDto, CancellationToken ct);

    Task<Result<bool>> DeleteByIdAsync(int consignmentId, CancellationToken ct);
}